                      ...
                      <Grid>
                        <Stack spacing={1} sx={{ alignItems: 'center', justifyContent: 'center' }}>
                          ...
                          <Typography variant="caption" sx={{ fontSize: '16px', textAlign: 'center' }}>
                            We have sent you instructions to reset your password. Please check your email, and don't forget to check your
                            spam folder as well.
                          </Typography>
                        </Stack>
                      </Grid>
                      <Link to="/pages/login">
                        <Button color="secondary" sx={{ w: '100%', mt: 2 }} fullWidth size="large" type="submit" variant="contained">
                          Login
                        </Button>
                      </Link>
                    </Grid>
