...
export default function TotalLightCard({ isLoading, total, icon, label }) {
...
TotalLightCard.propTypes = { isLoading: PropTypes.bool, total: PropTypes.number, icon: PropTypes.node, label: PropTypes.string };
